...
const HomePage = () => {
  const [logout, { loading, client }] = useMutation(LOGOUT, {
    // logout olduğunda refetch olup signin page yollanması için (GetAuthenticatedUser bizim yarattığımız query client tarafında)
  ...
  const handleLogout = async () => {
    try {
      ...
      // logout yaptığımızda bize ait olan datalar resetlensin diye.
      client.resetStore();
    } catch (error) {
